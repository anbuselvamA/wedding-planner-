...
const AboutPage = () => {
  ...
  return (
    <div className="about-page">
      <SEO
        title="About Us – Boss Event Decorator"
        description="Learn about Boss Event Decorator – a Virudhachalam-based luxury wedding planning company. Over 500 weddings crafted with love, precision, and elegance across India."
        path="/about"
      />
        ...
        <div className="container" data-aos="zoom-in" data-aos-duration="1200">
          <div className="about-hero-content">
            ...
            <p className="about-desc">
              At Boss Event Decorator, we believe every love story deserves 
        ...
        <div className="container">
          <div className="story-header" data-aos="fade-up">
            ...
            <p className="story-desc">
              Boss Event Decorator was born from a simple idea – to create stress-free, joyful and 
