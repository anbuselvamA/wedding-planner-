...
export const LocalBusinessSchema = () => {
  const schema = {
    ...
    name: 'Boss Event Decorator',
    description: 'Premium wedding planning services in Virudhachalam, Tamil Nadu. Full wedding planning, decor, photography, catering, and more.',
